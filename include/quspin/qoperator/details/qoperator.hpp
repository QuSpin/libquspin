...
struct qoperator : public typed_object<T> {
private:
  ssize_t dim_;
  array<T> data_;
  array<I> indptr_;
...
public:
  ...
  qoperator(ssize_t dim, array<T> data, array<I> indptr, array<I> indices,
            array<J> cindices)
...
using qoperators = std::variant<
    qoperator<int8_t, int32_t, uint8_t>, qoperator<int16_t, int32_t, uint8_t>,
    ...
    qoperator<cfloat, int64_t, uint16_t>,
    qoperator<cdouble, int64_t, uint16_t>>;
