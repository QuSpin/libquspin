...
namespace quspin::basis {
  ...
  template <typename I> class dit_perm  // permutation of dit locations
  {
  private:
  ...
  template <typename I> class bit_perm  // permutation of bit locations
  {
  private:
    benes::tr_benes<I> benes;
  ...
  public:
    ...
    template <typename T> dit_set<I> app(const dit_set<I>& s, T& coeff) const {
      dit_set<I> r(s);
    ...
    template <typename T> dit_set<I> inv(const dit_set<I>& s, T& coeff) const {
      dit_set<I> r(s);
