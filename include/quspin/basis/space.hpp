...
namespace quspin::basis {
  ...
  template <typename I, typename J> class dit_fullspace  // sps > 2
  {
  private:
  ...
  template <typename I, typename J, typename K> class dit_subspace  // sps > 2
  {
  private:
    const int lhss;            // local hilbert space sice
  ...
  template <typename I, typename J> class bit_fullspace  // sps = 2
  {
  private:
...
TEST_SUITE("quspin/basis/space.h") { using namespace quspin::basis; }
