...
static const quspin::details::basis::dit_integer_t mask[256] = {
...
namespace quspin::details::basis {  // explicit instantiation for code coverage
...
template bool operator>
    <uint8_t>(const dit_set<uint8_t>&, const dit_set<uint8_t>&);
template bool operator==
    <uint8_t>(const dit_set<uint8_t>&, const dit_set<uint8_t>&);
