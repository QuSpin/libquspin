...
template <typename T>
struct is_typed_object<typed_object<T>> : std::true_type {};

template <typename T>
constexpr bool is_typed_object_v = is_typed_object<T>::value;

using dtypes = std::variant<dtype<int8_t>, dtype<uint8_t>, dtype<int16_t>,
